...
const { createProduct, deleteProduct, getProducts, updateProduct, getProduct, filterByCategory, filterByPriceAsc, filterByPriceDesc, filterByText } = require('../controllers/product.controller');
